# SMF WhoDownloadedAttachment mod
...
## Description
This modification adds ability to show who download attachment. The list consists of a nickname, date and IP address.

### Features
* Ability to show who download attachment. The list is limited to 1000 members.
...
## Описание
Мод добавляет возможность просмотра списка пользователей скачавших вложение. Список содержит - ник со ссылкой на профиль, дата и время скачивания, IP адрес.
